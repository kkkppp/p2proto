...
public class ColumnMetaData {
    ...
    public ColumnMetaData(String name, String label, org.p2proto.ddl.Domain dataType, ColumnDefaultHolder defaultValue, Map<String, String> additionalProperties) {
        this(null, name, label, dataType, false, false, false, defaultValue, additionalProperties, TableMetadata.SelectDecorator.defaultDecorator(), TableMetadata.WhereDecorator.defaultDecorator());
    }

    public ColumnMetaData(UUID id, String name, String label, org.p2proto.ddl.Domain dataType, Boolean primaryKey, Boolean autoGenerated, Boolean removable, ColumnDefaultHolder defaultValue, Map<String, String> additionalProperties) {
        this(id, name, label, dataType, primaryKey, autoGenerated, removable, defaultValue, additionalProperties, TableMetadata.SelectDecorator.defaultDecorator(), TableMetadata.WhereDecorator.defaultDecorator());
    }
/*
    public ColumnMetaData(UUID id, String name, String label, org.p2proto.ddl.Domain dataType, Boolean primaryKey, Boolean autoGenerated, Boolean removable, ColumnDefaultHolder defaultValue, Map<String, String> additionalProperties, TableMetadata.SelectDecorator selectDecorator, TableMetadata.WhereDecorator whereDecorator) {
        this.id = id;
        this.name = name;
        this.label = label;
